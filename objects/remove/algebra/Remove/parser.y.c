...
#line 4 "algebra/Remove/parser.y"
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
#define YYSTYPE_IS_DECLARED 1
#line 93 "algebra/Remove/parser.y"
typedef union {
  char *SVal; } YYSTYPE;
#endif /* !YYSTYPE_IS_DECLARED */
#line 119 "objects/remove/algebra/Remove/parser.y.c"
...
#line 135 "algebra/Remove/parser.y"
...
#line 337 "objects/remove/algebra/Remove/parser.y.c"
...
yyreduce:
    ...
    {
case 3:
#line 111 "algebra/Remove/parser.y"
	{Copy_Name(yystack.l_mark[-5].SVal); Copy_End(yystack.l_mark[0].SVal);}
break;
case 4:
#line 112 "algebra/Remove/parser.y"
	{Copy_End(yystack.l_mark[0].SVal);}
break;
case 7:
#line 115 "algebra/Remove/parser.y"
	{Copy_Name(yystack.l_mark[0].SVal);}
break;
case 8:
#line 116 "algebra/Remove/parser.y"
	{Copy_Name(yystack.l_mark[-1].SVal);}
break;
case 9:
#line 117 "algebra/Remove/parser.y"
	{Copy_Name(yystack.l_mark[-2].SVal);}
break;
case 10:
#line 118 "algebra/Remove/parser.y"
	{Copy_Name(yystack.l_mark[-3].SVal);Copy_End(yystack.l_mark[0].SVal);}
break;
case 13:
#line 123 "algebra/Remove/parser.y"
	{Copy_Label(yystack.l_mark[0].SVal);}
break;
case 14:
#line 125 "algebra/Remove/parser.y"
	{istrrest=1; Tr_Rest=1;}
break;
case 16:
#line 126 "algebra/Remove/parser.y"
	{istrrest=0; Pl_Rest=1;}
break;
case 21:
#line 132 "algebra/Remove/parser.y"
	{Fill_Rest(yystack.l_mark[0].SVal);}
break;
#line 576 "objects/remove/algebra/Remove/parser.y.c"
    }
    yystack.s_mark -= yym;
